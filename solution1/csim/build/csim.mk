...
HLS_SOURCES = ../../../test.cpp ../../../test_cam.cpp ../../../core.cpp
...
$(ObjDir)/test_cam.o: ../../../test_cam.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../test_cam.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) -c -MMD   $(IFLAG) $(DFLAG)  $< -o $@ ; \

-include $(ObjDir)/test_cam.d
