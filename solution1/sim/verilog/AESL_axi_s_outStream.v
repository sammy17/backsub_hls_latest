...
`define TV_OUT_outStream_TDATA "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_data_V.dat"
`define EGRESS_STATUS_outStream_TDATA "../tv/stream_size/stream_egress_status_outStream_V_data_V.dat"
`define TV_OUT_outStream_TKEEP "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_keep_V.dat"
`define EGRESS_STATUS_outStream_TKEEP "../tv/stream_size/stream_egress_status_outStream_V_keep_V.dat"
`define TV_OUT_outStream_TSTRB "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_strb_V.dat"
`define EGRESS_STATUS_outStream_TSTRB "../tv/stream_size/stream_egress_status_outStream_V_strb_V.dat"
`define TV_OUT_outStream_TUSER "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_user_V.dat"
`define EGRESS_STATUS_outStream_TUSER "../tv/stream_size/stream_egress_status_outStream_V_user_V.dat"
`define TV_OUT_outStream_TLAST "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_last_V.dat"
`define EGRESS_STATUS_outStream_TLAST "../tv/stream_size/stream_egress_status_outStream_V_last_V.dat"
`define TV_OUT_outStream_TID "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_id_V.dat"
`define EGRESS_STATUS_outStream_TID "../tv/stream_size/stream_egress_status_outStream_V_id_V.dat"
`define TV_OUT_outStream_TDEST "../tv/rtldatafile/rtl.backsub.autotvout_outStream_V_dest_V.dat"
...
module AESL_axi_s_outStream (
	...
	input TRAN_outStream_TUSER,
	input TRAN_outStream_TLAST,
	input TRAN_outStream_TID,
	input TRAN_outStream_TDEST,
	...
	reg [1 - 1:0] outStream_TUSER_write_data;
	reg outStream_TUSER_read_en;
	wire [1 - 1:0] outStream_TUSER_read_data;
	
	fifo #(76800, 1) fifo_outStream_TUSER (
		.reset(1'b0),
		.write_clock(clk),
	...
	reg [1 - 1:0] outStream_TID_write_data;
	reg outStream_TID_read_en;
	wire [1 - 1:0] outStream_TID_read_data;
	
	fifo #(76800, 1) fifo_outStream_TID (
		.reset(1'b0),
		.write_clock(clk),
	...
	reg [1 - 1:0] outStream_TDEST_write_data;
	reg outStream_TDEST_read_en;
	wire [1 - 1:0] outStream_TDEST_read_data;
	
	fifo #(76800, 1) fifo_outStream_TDEST (
		.reset(1'b0),
		.write_clock(clk),
