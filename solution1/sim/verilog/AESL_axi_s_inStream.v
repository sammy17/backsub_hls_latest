...
module AESL_axi_s_inStream (
	...
	output TRAN_inStream_TUSER,
	output TRAN_inStream_TLAST,
	output TRAN_inStream_TID,
	output TRAN_inStream_TDEST,
	...
	fifo #(38400, 32) fifo_inStream_TDATA (
		.reset(1'b0),
		.write_clock(clk),
	...
	fifo #(38400, 4) fifo_inStream_TKEEP (
		.reset(1'b0),
		.write_clock(clk),
	...
	fifo #(38400, 4) fifo_inStream_TSTRB (
		.reset(1'b0),
		.write_clock(clk),
	...
	reg [1 - 1:0] inStream_TUSER_write_data;
	reg inStream_TUSER_read_en;
	wire [1 - 1:0] inStream_TUSER_read_data;
	
	fifo #(38400, 1) fifo_inStream_TUSER (
		.reset(1'b0),
		.write_clock(clk),
	...
	fifo #(38400, 1) fifo_inStream_TLAST (
		.reset(1'b0),
		.write_clock(clk),
	...
	reg [1 - 1:0] inStream_TID_write_data;
	reg inStream_TID_read_en;
	wire [1 - 1:0] inStream_TID_read_data;
	
	fifo #(38400, 1) fifo_inStream_TID (
		.reset(1'b0),
		.write_clock(clk),
	...
	reg [1 - 1:0] inStream_TDEST_write_data;
	reg inStream_TDEST_read_en;
	wire [1 - 1:0] inStream_TDEST_read_data;
	
	fifo #(38400, 1) fifo_inStream_TDEST (
		.reset(1'b0),
		.write_clock(clk),
